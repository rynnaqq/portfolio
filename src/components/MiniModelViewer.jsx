...
export default function MiniModelViewer({ title = "KINETIC_CORE_PROTOTYPE" }) {
  ...
  useEffect(() => {
    ...
    camera.position.z = isMobile ? 4.6 : 4.2;
  ...
  return (
    <div className="relative w-full rounded-2xl bg-oled/90 border border-white/10 p-3 sm:p-4 overflow-hidden">
      {/* HUD Header */}
      <div className="flex items-center justify-between font-mono text-[10px] text-zinc-400 border-b border-white/5 pb-2 mb-2">
        ...
        <div className="flex items-center gap-1.5">
          {[
            ...
            <button
              ...
              className={`px-2 py-0.5 rounded border transition-all text-[9px] sm:text-[10px] ${
                wireColor === c.color
