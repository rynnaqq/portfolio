...
export default function Footer() {
  ...
  return (
    <footer className="py-12 px-4 sm:px-8 border-t border-white/10 bg-oled font-mono text-xs text-zinc-500">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <Magnetic strength={0.3}>
          <button
            onClick={scrollToTop}
            className="group flex items-center gap-2 px-4 py-2 rounded-full bg-surface-card border border-white/10 hover:border-neon-lime text-zinc-400 hover:text-white transition-all duration-300 shadow-sm hover:shadow-neon-lime"
          >
